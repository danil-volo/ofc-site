export default function Home() {
  return (
    ...
    >
      <header>
        <img src="/logo-black.png" className="h-8" />
      </header>
      <div
      ...
      <div className="flex flex-col justify-center items-center space-y-24 p-8 text-red-900">
        ...
        <div className="flex lg:w-1/2 w-full md:flex-row flex-col justify-center md:space-x-12 space-y-4 items-center">
          <div className="w-64 flex flex-1 flex-col justify-between">
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-row justify-start space-x-8 mt-6">
                <a href="https://twitter.com/oddfriends_club" target="_blank">
                  <img src="/twitter-48.png" className="h-16" />
                </a>
                <a href="https://discord.com/invite/2X9UGY3qPJ" target="_blank">
                  <img src="/discord-new-48.png" className="h-16" />
                </a>
                <a
                  href="https://www.instagram.com/oddfriends.club/"
                  target="_blank"
                >
                  <img src="/instagram-80.png" className="h-16" />
                </a>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="flex flex-row">
              <img src="/friends-48.png" className="h-6 mr-2" />
              We are on a mission to build the largest friends community on
              Ethereum Blockchain.
            </p>
            <p className="flex flex-row">
              <img src="/community96.png" className="h-6 mr-2" />
              This Project is Completely Community Driven!
            </p>
            <p className="flex flex-row">
              <img src="/run-into-men-48.png" className="h-6 mr-2" />
        ...
        <div className="flex lg:w-1/2 w-full md:flex-row flex-col-reverse md:space-y-0 justify-center space-y-reverse space-y-8 space-x-0 items-center">
          <div className="text-xl flex-1 flex-shrink-0">
            <ul style={{ listStyle: "inside" }} className="space-y-3">
              <li className="flex flex-row">
                <i>
                  <img src="/friends-48.png" className="h-6 mr-2"></img>
                </i>
                Mint Price: Free + Gas
              </li>
              <li className="flex flex-row">
          ...
          <img src="/ofc.gif" className="max-w-none w-72 m-0" />
          {/* </div> */}
        </div>
      ...
      <footer className="bg-gray-800 text-white py-4 flex justify-center items-center flex-col mt-12">
        <div className="flex flex-row justify-start space-x-8 mt-6">
          <a href="https://twitter.com/oddfriends_club" target="_blank">
            <img src="/twitter-48.png" className="h-12" />
          </a>
          <a href="https://discord.com/invite/2X9UGY3qPJ" target="_blank">
            <img src="/discord-new-48.png" className="h-12" />
          </a>
          <a href="https://www.instagram.com/oddfriends.club/" target="_blank">
            <img src="/instagram-80.png" className="h-12" />
          </a>
        </div>

        <img src="/logo-white.png" className="w-96" />
      </footer>
    </div>
  );
}
